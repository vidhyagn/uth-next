...
class AlertModal extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Modal isOpen={modalStatus} toggle={this.toggle} className={this.state.className} centered>
                    ...
                    <ModalFooter>
                        {this.state.OKButton &&
                        <Button color="success" onClick={this.props.OKAction}>{this.state.OKText}</Button>
                        }
                        {this.state.CANCELButton &&
                        <Button color="danger" onClick={this.props.CANCELAction}>{this.state.CANCELText}</Button>
                        }
                    </ModalFooter>
                    }
                </Modal>
